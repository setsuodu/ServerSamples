...
namespace UserLogin
{
    ...
    public class WebTool
    {
        ...
        public static void SendRequest(string url, Action<WebResponse> callback)
        {
            UnityWebRequest req = WebRequest.Create(url);
            SendRequestAsync(req, callback);
        }

        public static void SendRequest(UnityWebRequest request, Action<WebResponse> callback)
        {
            SendRequestAsync(request, callback);
        }

        private static async void SendRequestAsync(UnityWebRequest request, Action<WebResponse> callback)
        {
            try
            {
