...
exports.login = (req, res) => {
    try {
        ...
        UserModel.patchUser(req.login.userId, {refresh_key: refresh_key, proof_key: "", password_recovery_key: "", last_login_time: new Date()});
...
exports.get_version = (req, res) =>{
    return res.status(201).send({version: config.version});
};
